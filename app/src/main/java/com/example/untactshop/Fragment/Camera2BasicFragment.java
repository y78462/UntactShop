...
public class Camera2BasicFragment extends Fragment
   ...
   /*
    ...
    public void setOnmOnImageAvailableListener(ImageReader.OnImageAvailableListener mOnImageAvailableListener){
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.change:
                if(facingid == CameraCharacteristics.LENS_FACING_FRONT){ //전면
    ...
    /**
     * Saves a JPEG {@link Image} into the specified {@link File}. 2 -> 내가만듬
    */
...
//                        Log.e("이미지업로드성공","이미지업로드성공"+downloadUri);
//                    } else {
//                        // Handle failures
//                        Log.e("이미지업로드실패","이미지업로드실패");
//                    }
